 ...
 *      money:"{string} 融资金额",
 *      minInvest:"{string} 起投金额",
 *      maxInvest:"{string} 最大可投金额",
 *      remainInvest:"{string} 剩余可投金额",
 *      publishTimeline:"{string} 发布日期（毫秒级时间戳。例：1504698000207）",
 *      expireTimeline:"{string} 截止日期（毫秒级时间戳，可计算剩余投资时间。例：1504698000207）",
 *      repaymentTimeline:"{string} 还款日期（毫秒级时间戳。例：1504698000207）",
 *      tips:"{string} 项目温馨提示",
...
router.all('/project/detail', function (req, res, next) {
    ...
    var project = {
        ...
        maxInvest: ['4000','3000'][yesOrNo],
        remainInvest:'190000',
        expireTimeline: '1504698000207',
        publishTimeline: '1504698000207',
        repaymentTimeline:"1504698000207",
        tips:'这个项目可以赚好多哦！',
        investTotalCount:'21',
 ...
 * @description
 *
 * https://localhost:5000/project/agreementConsult
 *
 * https://192.168.1.86:3000/project/agreementConsult
 *
 * @output {json} 还款计划
 * {
 *  code:"{int}    状态代码（0表示成功，其它值表示失败）",
