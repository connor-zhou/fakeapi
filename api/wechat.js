 ...
 *
 * @description
 * 已过期，改调 [wechat.invest](#/api/wechat.invest) 接口
 *
 * 使用方式：
 * 
 * 在微信页面端可以按如下方式调用
 ...
 * @description
 *
 * 已过期，改调  [wechat.hasLogin](#/api/wechat.hasLogin)  接口
 * 
 * 使用方式：
 * 
 * 在微信页面端可以按如下方式调用
